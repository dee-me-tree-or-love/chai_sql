...
from chai_sql.typing.type_parser import _arpeggio_parse


class TestStandardSyntax:
    def test_parse_start(self):
        text = "@chai_sql:check"
        result = _arpeggio_parse(text)
    ...
    def test_parse_start_with_schema(self):
    ...
    def test_parse_returns_number(self):
        ...
        # the input is nested inside the command
        assert result[0][3][0][1].rule_name == "app_type_expression"
        assert result[0][3][0][1].value == "N | u | m | b | e | r"
        assert result[0][3][0][1].flat_str() == "Number"

    def test_parse_newtype_age_is_number(self):
        ...
        assert result[0][3][0][3].rule_name == "app_type_expression"
